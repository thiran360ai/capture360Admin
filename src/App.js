...
const App = () => {
  ...
  useEffect(() => {
    const fetchProjectData = async () => {
      try {
        const response = await fetch(
          "https://3973-2409-4072-6e8f-befe-7c12-7ad2-88f1-629a.ngrok-free.app/building/projectlist/",
          {
            headers: {
    ...
    const fetchEmployeeData = async () => {
      try {
        const response = await fetch(
          "https://3973-2409-4072-6e8f-befe-7c12-7ad2-88f1-629a.ngrok-free.app/building/create_user/",
          {
            headers: {
              Accept: "application/json",
              "ngrok-skip-browser-warning": "98547",
