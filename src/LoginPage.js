...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://6081-2409-408d-3e91-34f1-cc8f-590c-8f98-7c3b.ngrok-free.app/building/login/',
        {
          username,
          password,
        },
  ...
  return (
    <div className="login-container">
      <div className="login-form" style={{marginBottom : "270px", paddingBottom: "30px", opacity: 0.7}}>
