...
const DataPage = () => {
  ...
  const handleView = async (row) => {
    ...
    try {
      const viewUrl = `https://4aae-157-49-242-245.ngrok-free.app/building/plans/project/${row.project}/`;
  ...
  const renderImage = (imageUrl, name) => {
    const url = `https://8f93-157-49-243-140.ngrok-free.app${imageUrl}`;
    return (
      <img
        src={url}
        alt={name}
                ...
                <TableRow key={index}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      style={{ width: "180px", backgroundColor: "#00509e", color: "#ffffff", margin: "10px 0", borderRadius: 9 }}
                    >
                      View Floor_Data
                    </Button>
                  </TableCell>
