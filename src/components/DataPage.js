...
const DataPage = () => {
  ...
  const renderImage = (imageUrl, name) => {
    const url = `https://6081-2409-408d-3e91-34f1-cc8f-590c-8f98-7c3b.ngrok-free.app${imageUrl}`;
    console.log("URL",url);
    return (
      <img
        src={url}
  ...
  const handleView = async (row) => {
    ...
    try {
      const viewUrl = `https://6081-2409-408d-3e91-34f1-cc8f-590c-8f98-7c3b.ngrok-free.app/building/plans/project/${row.project}/`;
