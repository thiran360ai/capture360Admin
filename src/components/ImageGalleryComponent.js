...
const ImageGalleryComponent = () => {
  ...
  const fetchImages = async (id) => {
    try {
      const response = await fetch(
        `https://3973-2409-4072-6e8f-befe-7c12-7ad2-88f1-629a.ngrok-free.app/building/video/${id}/frames/`,
        {
          headers: {
  ...
  useEffect(() => {
    if (dialogOpen) {
      const fetchVideoDetails = async () => {
        ...
        try {
          const response = await fetch(
            "https://3973-2409-4072-6e8f-befe-7c12-7ad2-88f1-629a.ngrok-free.app/building/api/video/details/",
            {
              headers: {
                Accept: "application/json",
                "ngrok-skip-browser-warning": "98547",
  ...
  const fetchImagesByDate = async (id, date, panel) => {
    try {
      const response = await fetch(
        `https://3973-2409-4072-6e8f-befe-7c12-7ad2-88f1-629a.ngrok-free.app/building/video/${id}/frames/?date=${encodeURIComponent(date)}`,
        {
          headers: {
            Accept: "application/json",
            "ngrok-skip-browser-warning": "98547",
