...
const PlanDetailsPage = () => {
  ...
  const renderImage = (imageUrl, name) => {
    const fullImageUrl = `https://4aae-157-49-242-245.ngrok-free.app${imageUrl}`;
    return (
      <img
        src={fullImageUrl}
        alt={name}
    ...
    <Box p={2}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        <Button
          ...
          style={{ backgroundColor: "#00509e", color: "#ffffff", margin: "10px 0", borderRadius: 4, marginLeft: '70%',width: '180px' }}
        >
          Create Plan
        </Button>
      </Box>
